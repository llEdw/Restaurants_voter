...
public class VoteController {
    ...
    @GetMapping(value = "/votes/restaurant", produces = MediaType.APPLICATION_JSON_VALUE)
    public int getRestaurantId() {
        log.info("get chosen restaurant");
        return voteService.getRestaurantId();
    }

    @GetMapping(value = "/votes/all", produces = MediaType.APPLICATION_JSON_VALUE)
